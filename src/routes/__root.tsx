...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "OdontoControl AI — Gestión inteligente para clínicas odontológicas" },
      ...
      { name: "twitter:description", content: "Agenda, pacientes, financiero, tratamientos y un motor de IA que identifica oportunidades y recupera ingresos — todo en un solo lugar." },
