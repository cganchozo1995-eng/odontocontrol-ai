...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gestión completa para clínicas odontológicas." },
      { property: "og:title", content: "OdontoControl AI" },
      { name: "twitter:title", content: "OdontoControl AI" },
      { property: "og:description", content: "Gestión completa para clínicas odontológicas." },
      { name: "twitter:description", content: "Gestión completa para clínicas odontológicas." },
