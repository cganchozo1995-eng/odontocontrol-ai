      ...
      <div className="min-h-screen flex w-full">
        ...
        <SidebarInset className="flex-1 flex flex-col">
          <div className="bg-amber-50 border-b border-amber-200 px-4 py-2 text-xs flex items-center gap-2">
            ...
            <span className="text-amber-900"><b>Modo demostración</b> · datos ficticios solo para visualización. Todo lo que ve funciona de verdad en el sistema real.</span>
            <Button asChild size="sm" className="ml-auto h-7 gradient-primary text-white">
              <Link to="/entrar">Crear cuenta gratis</Link>
            </Button>
          </div>
