...
function Page() {
  ...
  const cards = [
    ...
    },
    {
      ...
      title: "Procedimientos para promover",
  ...
  return (
    <>
      <PageHeader
        title="AI Growth"
        description="Oportunidades calculadas a partir de sus datos"
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <Button size="sm" variant="outline" disabled><MessageCircle className="size-3 mr-1" />WhatsApp masivo</Button>
                  </div>
                </div>
              </div>
            </CardContent>
