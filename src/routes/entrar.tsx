          ...
          <Tabs defaultValue="login">
            ...
            <TabsContent value="login">
              <form onSubmit={login} className="space-y-3 mt-4">
                <div className="space-y-1.5"><Label>Correo electrónico</Label><Input name="email" type="email" required /></div>
                <div className="space-y-1.5"><Label>Contraseña</Label><Input name="password" type="password" required /></div>
            ...
            <TabsContent value="signup">
              <form onSubmit={signup} className="space-y-3 mt-4">
                <div className="space-y-1.5"><Label>Nombre</Label><Input name="nome" required /></div>
                <div className="space-y-1.5"><Label>Correo electrónico</Label><Input name="email" type="email" required /></div>
                <div className="space-y-1.5"><Label>Contraseña</Label><Input name="password" type="password" minLength={6} required /></div>
                <Button type="submit" disabled={busy} className="w-full">
                  {busy && <Loader2 className="size-4 animate-spin mr-2" />}Crear cuenta
                </Button>
              </form>
            </TabsContent>
          </Tabs>
          <div className="text-center mt-4">
            <Link to="/demo/Dashboard" className="text-xs text-muted-foreground hover:text-primary">Ver demo sin registro →</Link>
          </div>
        </CardContent>
      </Card>
    </div>
