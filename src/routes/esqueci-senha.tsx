  ...
  return (
    <div className="min-h-screen grid place-items-center p-4 bg-[var(--surface)]">
      <Card className="w-full max-w-md">
        <CardHeader><CardTitle>Recuperar contraseña</CardTitle></CardHeader>
        <CardContent>
          <form onSubmit={submit} className="space-y-3">
            ...
            <Button type="submit" disabled={busy} className="w-full">Enviar enlace</Button>
            <Link to="/entrar" className="block text-center text-sm text-muted-foreground">Volver</Link>
          </form>
        </CardContent>
      </Card>
    </div>
