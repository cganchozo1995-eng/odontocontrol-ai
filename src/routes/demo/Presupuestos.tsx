...
const ST: Record<string, { txt: string; cls: string }> = {
  ...
  pendente:  { txt: "Pendiente",  cls: "bg-amber-100 text-amber-700 border-amber-200" },
  enviado:   { txt: "Enviado",   cls: "bg-sky-100 text-sky-700 border-sky-200" },
  recusado:  { txt: "Rechazado",  cls: "bg-red-100 text-red-700 border-red-200" },
};
              ...
              <CardContent className="p-0">
                ...
                {isOpen && (
                  <div className="border-t bg-muted/20 p-5 animate-fade-in">
                    <div className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-3">Ítems del presupuesto</div>
                    ...
                    <div className="flex gap-2 mt-4 flex-wrap">
                      <Button size="sm" className="gradient-primary text-white" onClick={() => toast.success("Aprobado y convertido en tratamiento (demo)")}>
                        <Check className="size-3.5 mr-1.5" />Aprobar
                      </Button>
                      <Button size="sm" variant="outline" onClick={() => toast.info("Marcado como rechazado (demo)")}>
