...
const TR_MAP: Record<string, string> = {
  ...
  "Implante Dentário": "Implante Dental",
  "Tratamento de Canal": "Endodoncia",
  "Clareamento + Facetas": "Blanqueamiento + Carillas",
  "Coroa de Porcelana": "Corona de Porcelana",
  "Reabilitação Total": "Rehabilitación Total",
  "Alinhador Invisível": "Alineador Invisible",
              ...
              <CardContent className="p-5">
                ...
                <div className="mt-4">
                  <div className="text-sm font-semibold flex items-center gap-2">
                    ...
                    {TR_MAP[t.descricao] || t.descricao}
                  </div>
                  {t.dente && t.dente !== "—" && <div className="text-xs text-muted-foreground mt-0.5">Diente: {t.dente}</div>}
                </div>
                ...
                <div className="mt-4">
                  <div className="flex items-center justify-between text-xs mb-1.5">
                    <span className="text-muted-foreground">Progreso · {t.etapas_concluidas}/{t.etapas_total} etapas</span>
