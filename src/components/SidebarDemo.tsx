      ...
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-2.5 px-2 py-2">
          ...
          <div className="min-w-0 group-data-[collapsible=icon]:hidden">
            ...
            <div className="text-xs text-sidebar-foreground/60">Modo demostración</div>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
        ...
        <SidebarGroup>
          <div className="px-3 pt-3 pb-1 text-[10px] uppercase tracking-wider text-sidebar-foreground/40 group-data-[collapsible=icon]:hidden">Próximamente en el demo</div>
          <SidebarGroupContent>
            <SidebarMenu>
              {extra.map((it) => (
