...
const groups = [
  {
    ...
    items: [
      ...
      { to: "/app/Profissionais", label: "Profesionales", icon: Stethoscope },
      { to: "/app/Procedimentos", label: "Procedimientos", icon: ListChecks },
    ],
  },
  {
    label: "Operacional",
    items: [
      { to: "/app/Tratamentos", label: "Tratamientos", icon: ClipboardList },
      { to: "/app/Orcamentos", label: "Presupuestos", icon: Receipt },
      { to: "/app/Financeiro", label: "Financiero", icon: DollarSign },
      { to: "/app/Relatorios", label: "Informes", icon: BarChart3 },
  ...
  },
  {
    label: "Gestión",
    items: [
      { to: "/app/Equipe", label: "Equipo", icon: UserCog },
      { to: "/app/Configuracoes", label: "Configuración", icon: Settings },
    ],
  },
] as const;
